...
#define HDHOMERUN_STATUS_COLOR_NEUTRAL 0
#define HDHOMERUN_STATUS_COLOR_RED 1
#define HDHOMERUN_STATUS_COLOR_YELLOW 2
#define HDHOMERUN_STATUS_COLOR_GREEN 3
...
extern int hdhomerun_device_set_tuner_filter_by_array(struct hdhomerun_device_t *hd, unsigned char filter_array[0x2000]);
